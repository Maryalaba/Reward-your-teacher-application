...
public class AuthController {
    ...
    public ResponseEntity<UserRegistrationResponse> signUpUser(@RequestBody UserDto userDto) {
    ...
    public ResponseEntity<UserRegistrationResponse> signUpTeacher(TeacherRegistrationDto teacherDto, @RequestPart MultipartFile validId) throws IOException {
        System.out.println(validId.getOriginalFilename());
        UserRegistrationResponse userRegistrationResponse = authService.registerTeacher(teacherDto, validId);
        return new ResponseEntity<>(userRegistrationResponse, HttpStatus.CREATED);
    }
